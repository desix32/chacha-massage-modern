...
export const UI_TRANSLATIONS: Record<SupportedLanguage, UIStrings> = {
  en: {
    ...
    hero_open_daily: "Open Daily 9:00 AM – 1:00 AM",
  ...
  th: {
    ...
    hero_open_daily: "เปิดบริการทุกวัน 9:00 - 01:00 น.",
  ...
  ja: {
    ...
    hero_open_daily: "年中無休 朝9:00〜深夜1:00",
  ...
  zh: {
    ...
    hero_cta: "预约您的身心水疗体验",
    hero_open_daily: "每日营业 9:00 - 凌晨1:00",
  ...
  ko: {
    ...
    hero_open_daily: "매일 영업: 오전 9:00 - 익일 새벽 1:00",
  ...
  hi: {
    ...
    hero_open_daily: "प्रतिदिन सुबह 9:00 से रात 1:00 बजे तक",
  ...
  ta: {
    ...
    hero_open_daily: "தினமும் காலை 9:00 முதல் இரவு 1:00 வரை",
  ...
  ar: {
    ...
    hero_open_daily: "مفتوح يومياً من 9:00 صباحاً حتى 1:00 ليلاً",
  ...
  ru: {
    ...
    hero_open_daily: "Ежедневно с 9:00 до 01:00",
  ...
  de: {
    ...
    hero_open_daily: "Täglich geöffnet von 9:00 bis 01:00 Uhr",
  ...
  fr: {
    ...
    hero_open_daily: "Ouvert tous les jours de 9h00 à 1h00",
